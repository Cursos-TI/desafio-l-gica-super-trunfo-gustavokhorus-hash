...
int main() {
    ...
    char continuar; // Variavel p/ condição de caractere para resposta do usuário ser em qualquer tecla
    float saldo = 3500, vsaque, fatura = 780.93;

    // Menu
    
      do{  // Abertura da condição de repetição
    ...
    printf("Voltar ao menu principal: 1=SIM / Qualquer tecla=NÃO\n");
    scanf(" %c", &continuar);

      } while(continuar == '1'); // Repete se a condição for atendida
        if(continuar != '1'){
            printf("\n");
            printf("Até mais!\n");
            printf("Banco Safra\n");
